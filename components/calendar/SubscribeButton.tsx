    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-gradient-to-t from-background to-transparent">
      <div className="max-w-container mx-auto">
        <button
          ...
          className="w-full py-4 px-6 bg-accent hover:bg-accent-hover text-background font-semibold rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl"
        >
